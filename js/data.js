      ...
      const TYPE_ARENAS = {
        Fire: {
          bg: "linear-gradient(180deg,rgba(20,8,6,.16),rgba(20,8,6,.28)),url('assets/backgrounds/arena-fire.png') center/100% 100% no-repeat",
          cloud: "rgba(255,219,184,.24)",
          plat: "rgba(158,73,37,.78)",
          pos: { ...ARENA_SIZE_TIGHT, playerX: 30, playerY: 84, enemyX: 66, enemyY: 57 },
        },
        Water: {
          bg: "linear-gradient(180deg,rgba(6,12,20,.16),rgba(6,12,20,.28)),url('assets/backgrounds/arena-water.png') center/100% 100% no-repeat",
          cloud: "rgba(180,210,255,.3)",
          plat: "rgba(50,90,160,.7)",
          pos: { ...ARENA_SIZE_SPACIOUS, playerX: 31, playerY: 78, enemyX: 66, enemyY: 55 },
        },
        Grass: {
          bg: "linear-gradient(180deg,rgba(10,20,10,.14),rgba(10,20,10,.24)),url('assets/backgrounds/arena-grass.png') center/100% 100% no-repeat",
          cloud: "rgba(230,255,214,.24)",
          plat: "rgba(78,130,66,.76)",
          pos: { ...ARENA_SIZE_TIGHT, playerX: 31, playerY: 77, enemyX: 66, enemyY: 56 },
        },
        Electric: {
          bg: "linear-gradient(180deg,rgba(20,18,6,.14),rgba(20,18,6,.24)),url('assets/backgrounds/arena-electric.png') center/100% 100% no-repeat",
          cloud: "rgba(255,245,180,.3)",
          plat: "rgba(180,160,50,.7)",
          pos: { ...ARENA_SIZE_TIGHT, playerX: 30, playerY: 85, enemyX: 66, enemyY: 61 },
        },
        Ice: {
          bg: "linear-gradient(180deg,rgba(10,16,22,.14),rgba(10,16,22,.24)),url('assets/backgrounds/arena-ice.png') center/100% 100% no-repeat",
          cloud: "rgba(200,230,255,.35)",
          plat: "rgba(120,170,200,.7)",
          pos: { ...ARENA_SIZE_TIGHT, playerX: 31, playerY: 80, enemyX: 66, enemyY: 53 },
        },
        Fighting: {
          bg: "linear-gradient(180deg,rgba(20,10,8,.16),rgba(20,10,8,.26)),url('assets/backgrounds/arena-fighting.png') center/100% 100% no-repeat",
          cloud: "rgba(255,200,180,.2)",
          plat: "rgba(160,60,40,.7)",
          pos: { ...ARENA_SIZE_SPACIOUS, playerX: 31, playerY: 81, enemyX: 66, enemyY: 57 },
        },
        Poison: {
          bg: "linear-gradient(180deg,rgba(16,8,20,.18),rgba(16,8,20,.28)),url('assets/backgrounds/arena-poison.png') center/100% 100% no-repeat",
          cloud: "rgba(225,255,214,.42)",
          plat: "rgba(94,124,46,.76)",
          pos: { ...ARENA_SIZE_TIGHT, playerX: 31, playerY: 79, enemyX: 66, enemyY: 56 },
        },
        Ground: {
          bg: "linear-gradient(180deg,rgba(22,16,8,.16),rgba(22,16,8,.26)),url('assets/backgrounds/arena-ground.png') center/100% 100% no-repeat",
          cloud: "rgba(255,230,190,.25)",
          plat: "rgba(170,130,70,.75)",
          pos: { ...ARENA_SIZE_STANDARD, playerX: 31, playerY: 83, enemyX: 66, enemyY: 60 },
        },
        Flying: {
          bg: "linear-gradient(180deg,rgba(12,14,22,.1),rgba(12,14,22,.2)),url('assets/backgrounds/arena-flying.png') center/100% 100% no-repeat",
          cloud: "rgba(255,255,255,.5)",
          plat: "rgba(130,110,180,.65)",
          pos: { ...ARENA_SIZE_STANDARD, playerX: 31, playerY: 78, enemyX: 66, enemyY: 55 },
        },
        Psychic: {
          bg: "linear-gradient(180deg,rgba(15,16,28,.1),rgba(15,16,28,.22)),url('assets/backgrounds/arena-psychic.png') center/100% 100% no-repeat",
          cloud: "rgba(255,255,255,.48)",
          plat: "rgba(125,101,194,.72)",
          pos: { ...ARENA_SIZE_STANDARD, playerX: 31, playerY: 80, enemyX: 66, enemyY: 56 },
        },
        Bug: {
          bg: "linear-gradient(180deg,rgba(14,18,8,.14),rgba(14,18,8,.24)),url('assets/backgrounds/arena-bug.png') center/100% 100% no-repeat",
          cloud: "rgba(220,240,200,.3)",
          plat: "rgba(100,130,50,.7)",
          pos: { ...ARENA_SIZE_TIGHT, playerX: 31, playerY: 85, enemyX: 66, enemyY: 57 },
        },
        Rock: {
          bg: "linear-gradient(180deg,rgba(26,18,8,.16),rgba(26,18,8,.28)),url('assets/backgrounds/arena-rock.png') center/100% 100% no-repeat",
          cloud: "rgba(255,236,210,.2)",
          plat: "rgba(148,112,64,.78)",
          pos: { ...ARENA_SIZE_STANDARD, playerX: 31, playerY: 80, enemyX: 66, enemyY: 57 },
        },
        Ghost: {
          bg: "linear-gradient(180deg,rgba(14,10,24,.18),rgba(14,10,24,.28)),url('assets/backgrounds/arena-ghost.png') center/100% 100% no-repeat",
          cloud: "rgba(196,181,255,.22)",
          plat: "rgba(84,61,152,.74)",
          pos: { ...ARENA_SIZE_STANDARD, playerX: 31, playerY: 81, enemyX: 66, enemyY: 57 },
        },
        Dragon: {
          bg: "linear-gradient(180deg,rgba(9,12,18,.16),rgba(9,12,18,.3)),url('assets/backgrounds/arena-dragon.png') center/100% 100% no-repeat",
          cloud: "rgba(243,247,255,.34)",
          plat: "rgba(96,93,78,.76)",
          pos: { ...ARENA_SIZE_STANDARD, playerX: 31, playerY: 80, enemyX: 66, enemyY: 57 },
        },
        Dark: {
          bg: "linear-gradient(180deg,rgba(10,8,6,.2),rgba(10,8,6,.35)),url('assets/backgrounds/arena-dark.png') center/100% 100% no-repeat",
          cloud: "rgba(180,170,160,.15)",
          plat: "rgba(90,70,55,.75)",
          pos: { ...ARENA_SIZE_STANDARD, playerX: 31, playerY: 82, enemyX: 66, enemyY: 58 },
        },
        Steel: {
          bg: "linear-gradient(180deg,rgba(14,14,18,.14),rgba(14,14,18,.26)),url('assets/backgrounds/arena-steel.png') center/100% 100% no-repeat",
          cloud: "rgba(210,210,220,.25)",
          plat: "rgba(140,140,160,.7)",
          pos: { ...ARENA_SIZE_SPACIOUS, playerX: 31, playerY: 82, enemyX: 66, enemyY: 57 },
        },
        Fairy: {
          bg: "linear-gradient(180deg,rgba(20,12,16,.12),rgba(20,12,16,.22)),url('assets/backgrounds/arena-fairy.png') center/100% 100% no-repeat",
          cloud: "rgba(255,200,220,.3)",
          plat: "rgba(180,110,140,.65)",
          pos: { ...ARENA_SIZE_TIGHT, playerX: 31, playerY: 82, enemyX: 66, enemyY: 58 },
        },
        Normal: {
          bg: "linear-gradient(180deg,rgba(110,181,255,.12),rgba(61,122,48,.18)),url('assets/backgrounds/arena-normal.png') center/100% 100% no-repeat",
          cloud: "rgba(255,255,255,.5)",
      ...
      const GUIDE_BACKDROP_ARENAS = [
        ...
        })),
        {
          ...
          label: "Muk",
          theme: {
            bg: "linear-gradient(180deg,rgba(15,8,18,.18),rgba(15,8,18,.3)),url('assets/backgrounds/arena-muk.png') center/100% 100% no-repeat",
        ...
        },
        {
          ...
          label: "Haunter",
          theme: {
            bg: "linear-gradient(180deg,rgba(14,10,24,.18),rgba(14,10,24,.3)),url('assets/backgrounds/arena-haunter.png') center/100% 100% no-repeat",
            cloud: "rgba(196,181,255,.22)",
            plat: "rgba(84,61,152,.74)",
            pos: { ...ARENA_SIZE_STANDARD, playerX: 31, playerY: 81, enemyX: 66, enemyY: 57 },
          },
        },
        {
          ...
          label: "Gengar",
          theme: {
            bg: "linear-gradient(180deg,rgba(14,10,24,.18),rgba(14,10,24,.32)),url('assets/backgrounds/arena-gengar.png') center/100% 100% no-repeat",
        ...
        },
        {
          ...
          label: "Hydreigon",
          theme: {
            bg: "linear-gradient(180deg,rgba(9,12,18,.18),rgba(9,12,18,.34)),url('assets/backgrounds/arena-hydreigon.png') center/100% 100% no-repeat",
        ...
        },
        {
          ...
          label: "Mewtwo",
          theme: {
            bg: "linear-gradient(180deg,rgba(15,16,28,.12),rgba(15,16,28,.28)),url('assets/backgrounds/arena-mewtwo.png') center/100% 100% no-repeat",
